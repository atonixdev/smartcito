...
def build_rfp_packet() -> dict[str, object]:
    ...
    return {
        "title": "SmartCito Drone Platform RFP Packet",
        "document_style": "PDF-ready markdown packet",
        "executive_summary": {
            "procurement_model": "Manufacturer builds the airframe and electronics; SmartCito owns companion-computer software and cloud stack.",
            "target_architecture": "PX4/ArduPilot + companion computer + RGB/thermal/zoom camera + 4G/5G/WiFi uplink into SmartCito.",
        },
        "sections": [
            "Program Overview",
        ...
        "acceptance_checklist": [
            ...
            "SmartCito team can install ROS2 nodes, SDK, and video streamer.",
            ...
            "4G/5G or WiFi uplink reaches SmartCito cloud endpoints.",
            "Thermal envelope supports sustained encode and ROS2 autonomy runtime.",
        ],
        "vendor_response_questions": [
            "Can you deliver this airframe and electronics while preserving SmartCito software control?",
