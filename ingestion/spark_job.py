"""Declarative metadata for the SmartCito Spark streaming job."""
...
def build_stream_description() -> dict[str, object]:
    ...
    return {
        "source": "kafka",
        "input_topic": os.getenv("KAFKA_RAW_EVENTS_TOPIC", "smartcito.sensors.raw"),
        ...
        "alerts_topic": os.getenv("KAFKA_ALERTS_TOPIC", "smartcito.alerts"),
