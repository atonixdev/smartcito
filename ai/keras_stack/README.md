...
This package adds a Keras-first modular model stack to the existing Orca AI bundle.
...
- `common/export.py` - consistent Keras export and artifact manifest generation
- `pipeline.py` - unified inference wrapper over the modular model artifacts

## Export Contract

Each module saves a Keras artifact directory that can include:
