"""Unified inference wrapper over the modular Orca Keras model artifacts."""
...
from ai.keras_stack.models.anomaly_detection.infer import score_sequence_anomaly
from ai.keras_stack.models.drone_vision.infer import classify_image
from ai.keras_stack.models.gps_classification.infer import classify_gps_sequence
from ai.keras_stack.models.sensor_fusion.infer import score_sensor_fusion
from ai.keras_stack.models.trajectory_prediction.infer import predict_trajectory


class OrcaKerasPipeline:
    def __init__(
        self,
        *,
