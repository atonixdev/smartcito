...
from ai.model_stack.common.schema import VisionClassificationExample
from ai.model_stack.models.drone_vision.model import build_drone_vision_cnn
...
def train_drone_vision_model(dataset_path: str | Path, *, output_dir: str | Path) -> dict[str, Any]:
    keras, _layers = __import__("ai.model_stack.common.backend", fromlist=["require_keras"]).require_keras()
