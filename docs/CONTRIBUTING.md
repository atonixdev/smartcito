...
1. Start from the dataset schema in [ai/training/dataset_format.md](ai/training/dataset_format.md).
...
To publish the generated Kaggle bundle, use [ai/training/publish_kaggle_dataset.py](ai/training/publish_kaggle_dataset.py) or `scripts/ai.sh publish-kaggle` after configuring your Kaggle API token.
